...
const stats = [
  { key: "departments", value: "640+", icon: "📐" },
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(ellipse, rgba(59,130,246,0.12), transparent 60%)",
            filter: "blur(60px)",
            pointerEvents: "none",
          }}
          className="float"
          ...
          >
            {tx.hierarchy.levels.map((level, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center" }}>
                ...
                {i < tx.hierarchy.levels.length - 1 && (
                  <div
                    style={{
                      padding: "0 8px",
                      color: "var(--muted-foreground)",
  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        transition:
          "transform 0.15s, box-shadow 0.15s, background-color 0.15s, border-color 0.15s",
        cursor: "pointer",
      }}
      onMouseEnter={(e) => {
        (e.currentTarget as HTMLDivElement).style.transform =
