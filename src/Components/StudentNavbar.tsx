        ...
        >
          ...
          >
            ...
            <div className="space-y-3 text-sm text-[#A5B4BF] leading-relaxed">
              <p>
                <strong className="text-[#F8FAFC]">دراستي</strong> هي منصة أكاديمية شاملة صُممت خصيصاً لمساعدة الطلاب في الوصول السريع والمنظم إلى كافة المقررات الدراسية، المحاضرات، الكتب والمراجع، الواجبات، ونماذج الامتحانات السابقة.
              </p>
              <p>
                تعتمد المنصة هيكلية واضحة تنقلك من القسم الأكاديمي إلى المستوى، فالفصل الدراسي، وصولاً إلى المادة المطلوبة بضغطة زر واحدة.
              </p>
            </div>
